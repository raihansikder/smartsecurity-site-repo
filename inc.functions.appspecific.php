...
/**
 * @var boolean Shows rate in the email sent
 */
$showrate = FALSE;
...
function notifySecurityAssignmentAdd($sa_id) {
  ...
  if ($sendEmail) {
    ...
    $lb = '<br>';
    $Body = "<span style='font-family:Courier New, Courier, monospace; font-size:12px'>" .
